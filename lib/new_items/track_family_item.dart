        ...
        GestureDetector(
          onTap: (){
            Get.to(RiderMap(
              ...
              dName:
             familyListDataModel.driverName.toString() == "null" ? "Data Not Available" : familyListDataModel.driverName.toString(),
              dLicenseNo: familyListDataModel.drivingLicenceNumber.toString() == "null" ?
              "Data Not Available" :  familyListDataModel.drivingLicenceNumber.toString(),
              vModel: familyListDataModel.vehicleModel.toString() == "null" ? "Data Not Available" : familyListDataModel.vehicleModel.toString(),
              vOwnerName:
              familyListDataModel.ownerName.toString() == "null" ? "Data Not Available" : familyListDataModel.ownerName.toString(),
              vRegistration: familyListDataModel.vehicleRegistrationNumber.toString() == "null" ?
              "Data Not Available" : familyListDataModel.vehicleRegistrationNumber.toString(),
              dMobile: familyListDataModel.driverMobileNumber.toString() == "null" ? "Data Not Available" : familyListDataModel.driverMobileNumber.toString(),
              dImage: familyListDataModel.driverPhoto.toString() == "null" ? "Data Not Available" : familyListDataModel.driverPhoto.toString(),
              memberName:
              familyListDataModel.memberName.toString() == "null" ? "Data Not Available" : familyListDataModel.memberName.toString(),
            ));
          },
          child: Card(
              elevation: 10,
