...
TripDataModel dataFromJson(String str) => TripDataModel.fromJson(json.decode(str));
String dataToJson(TripDataModel data) => json.encode(data.toJson());
class TripDataModel {
  TripDataModel({
    this.id,
    this.userId,
  ...
  TripDataModel.fromJson(dynamic json) {
    id = json['_id'];
    userId = json['user_id'];
  ...
  String? vehiclePhoto;
  String? vehicleOwner;
  TripDataModel copyWith({  String? id,
    String? userId,
    String? driverId,
    String? date,
    dynamic fromDestination,
