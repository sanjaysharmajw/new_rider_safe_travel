...
UserFamilyListModel userFamilyListModelFromJson(String str) =>
    UserFamilyListModel.fromJson(json.decode(str));
String userFamilyListModelToJson(UserFamilyListModel data) =>
...
FamilyMembersData dataFromJson(String str) =>
    FamilyMembersData.fromJson(json.decode(str));
